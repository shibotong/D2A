...
struct SyncingDataTests {
    ...
    func testSyncing() async throws {
        ...
        let l1tLocalization = try #require(left1Talent.fetchLocalization(language: .english))
        ...
        let r1tLocalization = try #require(right1Talent.fetchLocalization(language: .english))
        ...
        let l2tLocalization = try #require(left2Talent.fetchLocalization(language: .english))
        ...
        let r2tLocalization = try #require(right2Talent.fetchLocalization(language: .english))
        ...
        let l3tLocalization = try #require(left3Talent.fetchLocalization(language: .english))
        ...
        let r3tLocalization = try #require(right3Talent.fetchLocalization(language: .english))
        ...
        let l4tLocalization = try #require(left4Talent.fetchLocalization(language: .english))
        ...
        let r4tLocalization = try #require(right4Talent.fetchLocalization(language: .english))
