...
//    static let killEvent2 = LiveMatchKillEvent(time: 100, kill: [1], died: [6, 7, 8, 9, 10], players: .preview, heroDatabase: ConstantsController(heroes: loadSampleHero()!)).generateEvent()
//    static let killEvent3 = LiveMatchKillEvent(time: 100, kill: [7], died: [1, 2, 3, 4, 5], players: .preview, heroDatabase: ConstantsController(heroes: loadSampleHero()!)).generateEvent()
//
